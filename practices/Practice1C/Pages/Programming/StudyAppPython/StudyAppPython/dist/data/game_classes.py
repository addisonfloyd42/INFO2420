...
class Clinton:
    def __init__(self,x, y, w, h, speed, trans, max_dist):
        ...
        self.image = tf.scale(pygame.image.load(os.path.join("data","Assets","BillClinton.png")),(w,h))
...
class Bernie:
    def __init__(self, x, y, w, h):
        self.rect = pygame.Rect(x,y,w,h)
        self.init_x, self.init_y = x, y
        self.image = self.image = tf.scale(pygame.image.load(os.path.join("data","Assets","Bern.png")),(w,h))
        self.flip = False
