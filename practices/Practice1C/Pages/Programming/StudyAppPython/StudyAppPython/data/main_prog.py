import pygame, os, asyncio, time, colorsys
...
async def level_run(WIN: pygame.display, cheney:Char, ground_list, enemy_list, checkpoints, bullet_list, h_scroll, main_cont, level, pause_gui, main_song:Sound, saveless:bool, start_color, deaths):
    def font(size):
    ...
    sfx = SoundGroup(
        hit_sound = Sound(mixer.Sound(os.path.join(BASE_DIR,'Music','exp_fin.ogg')),1),
        jump_sound = Sound(mixer.Sound(os.path.join(BASE_DIR,'Music','jump_fin.ogg')),1),
        check_sound = Sound(mixer.Sound(os.path.join(BASE_DIR,'Music','check_fin.ogg')),0.15)
    )
    ...
    if main_cont.used:
        main_screen.add_to_dict("cont_icon",GUIElement(0,0,75,75,tf.scale(pygame.image.load(os.path.join(ASSETS_DIR,"Controller.png")),(75,75)),127))
    else:
        main_screen.add_to_dict("cont_icon",GUIElement(0,0,75,75,tf.scale(pygame.image.load(os.path.join(ASSETS_DIR,"WASD.png")),(75,75)),127))
    ...
    while run:
        ...
        if main_cont.used:
            main_screen.surf_dict["cont_icon"] = GUIElement(0,0,75,75,tf.scale(pygame.image.load(os.path.join(ASSETS_DIR,"Controller.png")),(75,75)),127)
        else:
            main_screen.surf_dict["cont_icon"] = GUIElement(0,0,75,75,tf.scale(pygame.image.load(os.path.join(ASSETS_DIR,"WASD.png")),(75,75)),127)
        #text update
