...
CHARACTER_IMAGE = tf.scale(pygame.image.load(os.path.join(ASSETS_DIR,"DickCheney.png")), (150,150))
CHARACTER_IMAGE_JUMP = tf.scale(pygame.image.load(os.path.join(ASSETS_DIR,"DickCheneyJump.png")), (150,150))
CHARACTER_IMAGE_DIE = tf.flip(tf.scale(pygame.image.load(os.path.join(ASSETS_DIR,"DickCheneyDie.png")), (150,150)),True,False)
